...
public class delete1 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if(evt.getSource()==bsubmit){
			int b=JOptionPane.showConfirmDialog(null, "Do you really delete?","delete or not", JOptionPane.YES_NO_OPTION);
				if(b==0){
				...
				// TODO Auto-generated catch block
						...
						JOptionPane.showMessageDialog(null, "Your account Delete Successfully");
				}
		}
